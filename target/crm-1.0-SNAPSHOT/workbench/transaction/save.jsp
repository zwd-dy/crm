...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
	...
	<script>
		...
		$(function (){
			...
			// 为阶段下拉框绑定选中下拉框的事件，用来填写可能性
			$("#create-stage").change(function(){
				// 取得选中的阶段
				var stage = $("#create-stage").val();
				/*
					我们要做的是
					把java中的 pMap 对象转换为js中的 json
				 */
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="测试测试666abc444">
				<input type="hidden" name="activityId" value="23d1d3b2bae1442885edd480baa2def7">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="4086b186f3dc431cb94a04972bb72c6a">
			</div>
		</div>
